...
# Using Thin Mode (no Oracle Client required)

def get_wowcher_user_id_from_owner_id(hubspot_owner_id):
    """
    Pipeline: HubSpot Owner ID -> Email -> Wowcher User ID
    """
    try:
        # Step 1: Get email for HubSpot owner ID
        owner_url = f"https://api.hubapi.com/crm/v3/owners/{hubspot_owner_id}?idProperty=id&archived=false"
        headers = {
...
print(get_wowcher_user_id_from_owner_id(29305346))